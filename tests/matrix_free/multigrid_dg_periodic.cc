...
class MGTransferMF
  : public MGTransferPrebuilt<parallel::distributed::Vector<typename LAPLACEOPERATOR::value_type>>
{
public:
  MGTransferMF(const MGLevelObject<LAPLACEOPERATOR> &laplace) : laplace_operator(laplace){};
...
do_test(const DoFHandler<dim> &dof)
{
  ...
  PreconditionMG<dim, parallel::distributed::Vector<double>, MGTransferMF<LevelMatrixType>>
