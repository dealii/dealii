 ...
 *
 * This command partitions the mesh into `N` parts, automatically generates
 * ghost cells, and splits the mesh into individual files—one for each
 * processor.
 *
...
namespace Step40
{
  ...
  LaplaceProblem<dim>::run()
  {
    ...
    Gmsh::read_partitioned_msh(triangulation,
                               mpi_communicator,
                               SOURCE_DIR "/../grid/grids/square-quad");
