...
// like 38, but check
// LinearAlgebra::TpetraWrappers::Vector<double>::add(std::vector<types::global_dof_index>,
// dealii::Vector)
...
{
  std::vector<dealii::types::global_dof_index> indices(v.size());
