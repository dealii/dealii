...
// This test is like vector_nonlocal_addition, but checks that we can call
// compress() multiple times, even if entries on only some of the ranks have
// been modified.
...
test()
{
  ...
  // Print the result after the first addition on each process
