...
// LinearAlgebra::TpetraWrappers::BlockSparseMatrix::add() and a
// FullMatrix<double> with setting the same elements on an element-by-element
// level. Use the entries as they would result from a vector-valued problem with
// a Laplace operator in 1D in each component
