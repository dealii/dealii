...
// Tests passing of settings in
// LinearAlgebra::TpetraWrappers::SolverBase::AdditionalData
...
Test_Solver_Output::solve_base()
{
  ...
  LinearAlgebra::TpetraWrappers::SolverBase::AdditionalData solver_data(true);
  LinearAlgebra::TpetraWrappers::SolverBase                 solver(
    LinearAlgebra::TpetraWrappers::SolverBase::cg, solver_control, solver_data);
...
Test_Solver_Output::solve_cgs()
{
  ...
  SolverControl solver_control(100, 1e-12);
  LinearAlgebra::TpetraWrappers::SolverCGS::AdditionalData solver_data(true);
  LinearAlgebra::TpetraWrappers::SolverCGS solver(solver_control, solver_data);
  solver.solve(system_matrix,
               completely_distributed_solution,
               system_rhs,
               prec);
...
Test_Solver_Output::solve_bicgstab()
{
  ...
  SolverControl solver_control(100, 1e-12);
  LinearAlgebra::TpetraWrappers::SolverBicgstab::AdditionalData solver_data(
    true);
  LinearAlgebra::TpetraWrappers::SolverBicgstab solver(solver_control,
                                                       solver_data);
  solver.solve(system_matrix,
               completely_distributed_solution,
               system_rhs,
...
Test_Solver_Output::solve_tfqmr()
{
  ...
  SolverControl solver_control(100, 1e-12);
  LinearAlgebra::TpetraWrappers::SolverTFQMR::AdditionalData solver_data(true);
  LinearAlgebra::TpetraWrappers::SolverTFQMR solver(solver_control,
                                                    solver_data);
  solver.solve(system_matrix,
               completely_distributed_solution,
               system_rhs,
