...
// Test
// LinearAlgebra::distributed::Vector::operator=(LinearAlgebra::TpetraWrappers::MPI::BlockVector&)
...
test()
{
  ...
  LinearAlgebra::TpetraWrappers::Vector<double> vb_one(local_active,
                                                       MPI_COMM_WORLD);
  LinearAlgebra::TpetraWrappers::Vector<double> v_one(local_active,
                                                      local_relevant,
                                                      MPI_COMM_WORLD);
  ...
  LinearAlgebra::TpetraWrappers::MPI::BlockVector vb(2), v(2);
