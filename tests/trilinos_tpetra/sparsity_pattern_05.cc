...
main(int argc, char **argv)
{
  ...
  LinearAlgebra::TpetraWrappers::SparsityPattern A(partitioning);
  A.add(2, 1);
  A.compress();

  // Check copy_from(LinearAlgebra::TpetraWrappers::SparsityPattern):
  LinearAlgebra::TpetraWrappers::SparsityPattern B;
  B.copy_from(A);
