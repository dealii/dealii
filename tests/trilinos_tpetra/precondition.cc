...
Step4<dim>::solve(int cycle)
{
  ...
  //     static constexpr std::array<unsigned int, 2>              lower{{73,
  //     145}}; TrilinosWrappers::PreconditionBlockJacobi preconditioner;
  ...
  //     static constexpr std::array<unsigned int, 2>            lower{{30,
  //     59}}; TrilinosWrappers::PreconditionBlockSSOR preconditioner;
  ...
  //     static constexpr std::array<unsigned int, 2>            lower{{23,
  //     46}}; TrilinosWrappers::PreconditionChebyshev preconditioner;
