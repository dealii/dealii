...
Step4<dim>::solve(int cycle)
{
...

  {
    ...
    LinearAlgebra::TpetraWrappers::PreconditionSSOR preconditioner;
    solution = 0;
    SolverControl solver_control(1000, 1e-10);
    SolverCG<>    solver(solver_control);
    preconditioner.initialize(system_matrix);
...

  {
    ...
    LinearAlgebra::TpetraWrappers::PreconditionSOR preconditioner;
    solution = 0;
...

  {
    ...
    LinearAlgebra::TpetraWrappers::PreconditionBlockJacobi preconditioner;
    LinearAlgebra::TpetraWrappers::PreconditionBlockJacobi::AdditionalData data;
    data.block_size = 16;
    solution        = 0;
    SolverControl solver_control(1000, 1e-10);
    SolverCG<>    solver(solver_control);
...

  {
    ...
    LinearAlgebra::TpetraWrappers::PreconditionBlockSSOR preconditioner;
    LinearAlgebra::TpetraWrappers::PreconditionBlockSSOR::AdditionalData data;
    data.block_size = 16;
    data.omega      = 1.2;
    solution        = 0;
    SolverControl solver_control(1000, 1e-10);
...

  {
    ...
    LinearAlgebra::TpetraWrappers::PreconditionBlockSOR preconditioner;
    LinearAlgebra::TpetraWrappers::PreconditionBlockSOR::AdditionalData data;
    data.block_size = 16;
    data.omega      = 0.8;
    solution        = 0;
    SolverControl    solver_control(1000, 1e-5);
...

  {
    ...
    LinearAlgebra::TpetraWrappers::PreconditionIC preconditioner;
    solution = 0;
    SolverControl solver_control(1000, 1e-10);
    SolverCG<>    solver(solver_control);
    preconditioner.initialize(system_matrix);
...

  {
    ...
    deallog.push("ILU");
    LinearAlgebra::TpetraWrappers::PreconditionILU preconditioner;
    solution = 0;
    SolverControl solver_control(1000, 1e-10);
    SolverCG<>    solver(solver_control);
    preconditioner.initialize(system_matrix);
...

  {
    ...
    LinearAlgebra::TpetraWrappers::PreconditionILUT preconditioner;
    LinearAlgebra::TpetraWrappers::PreconditionILUT::AdditionalData data;
    data.ilut_drop = 1e-6;
    data.ilut_fill = 3;
    solution       = 0;
    SolverControl    solver_control(1000, 1e-5);
...

  {
    ...
    LinearAlgebra::TpetraWrappers::PreconditionChebyshev preconditioner;
    LinearAlgebra::TpetraWrappers::PreconditionChebyshev::AdditionalData data;
  ...
  {
    deallog.push("Direct");
    LinearAlgebra::TpetraWrappers::PreconditionBlockwiseDirect preconditioner;
    solution = 0;
    SolverControl solver_control(1000, 1e-10);
    SolverCG<>    solver(solver_control);
    preconditioner.initialize(system_matrix);
