...
// check LinearAlgebra::TpetraWrappers::Vector<double>::operator = (const
// ::Vector
// &)
...
test(LinearAlgebra::TpetraWrappers::Vector<double> &v)
{
  ...
  LinearAlgebra::TpetraWrappers::Vector<double> w1;
  w1.reinit(complete_index_set(v.size()), MPI_COMM_WORLD);
  w1 = w;
  LinearAlgebra::TpetraWrappers::Vector<double> x1;
