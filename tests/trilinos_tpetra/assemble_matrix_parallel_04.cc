...
private:
  ...
  LinearAlgebra::TpetraWrappers::BlockSparseMatrix reference_matrix;
  LinearAlgebra::TpetraWrappers::BlockSparseMatrix test_matrix;

  LinearAlgebra::TpetraWrappers::MPI::BlockVector reference_rhs;
  LinearAlgebra::TpetraWrappers::MPI::BlockVector test_rhs;
...
LaplaceProblem<dim>::setup_system()
{
  ...
  LinearAlgebra::TpetraWrappers::BlockSparsityPattern csp(2, 2);
