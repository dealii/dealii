...
bool
operator==(const LinearAlgebra::TpetraWrappers::MPI::BlockVector &v1,
           const LinearAlgebra::TpetraWrappers::MPI::BlockVector &v2)
{
  if (v1.size() != v2.size())
    return false;
...
test()
{
  ...
  if (true)
    {
      LinearAlgebra::TpetraWrappers::MPI::BlockVector v1;
      v1.reinit(ivector);
      LinearAlgebra::TpetraWrappers::MPI::BlockVector v2;
      v2.reinit(ivector);
      ...
      // through iterators
      LinearAlgebra::TpetraWrappers::MPI::BlockVector::iterator p2 = v2.begin();
  ...
  if (true)
    {
      ...
      LinearAlgebra::TpetraWrappers::MPI::BlockVector::iterator p1 = v1.begin();
  ...
  if (true)
    {
      ...
      LinearAlgebra::TpetraWrappers::MPI::BlockVector::const_iterator p1 =
        v1.begin();
      for (unsigned int i = 0; i < v1.size(); ++i, ++p1)
        AssertThrow(*p1 == i, ExcInternalError());
  ...
  if (true)
    {
      ...
      // check advance
      LinearAlgebra::TpetraWrappers::MPI::BlockVector::iterator p2 = v1.begin();
      std::advance(p2, v1.size());
      deallog << "Check 13: " << (p2 == v1.end() ? "true" : "false")
              << std::endl;

      LinearAlgebra::TpetraWrappers::MPI::BlockVector::const_iterator p3 =
        v1.begin();
  ...
  if (true)
    {
      ...
      for (unsigned int i = 0; i < v1.size(); ++i)
        {
          const LinearAlgebra::TpetraWrappers::MPI::BlockVector::iterator p =
            (v1.begin() + i);
