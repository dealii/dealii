...
main(int argc, char **argv)
{
  ...
  LinearAlgebra::TpetraWrappers::SparsityPattern sp(partitioning);
  sp.add(2, 1);
  sp.compress();
  ...
  LinearAlgebra::TpetraWrappers::SparseMatrix<double> B(std::move(A));
  ...
  LinearAlgebra::TpetraWrappers::SparsityPattern sp_2(partitioning);
  sp_2.add(1, 2);
  sp_2.compress();
  A.reinit(sp_2);
  A.add(1, 2, 2.0);
