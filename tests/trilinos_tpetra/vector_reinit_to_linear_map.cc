...
// run LinearAlgebra::TpetraWrappers::Vector<double>::reinit() in MPI
// environment and with an IndexSet that is_ascending_and_one_to_one to check
...
test()
{
  ...
  LinearAlgebra::TpetraWrappers::Vector<double> vector_linear;
