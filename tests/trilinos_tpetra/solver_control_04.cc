...
#include <deal.II/lac/trilinos_tpetra_linear_operator.h>
...
main(int argc, char **argv)
{
...

  {
    ...
    LinearAlgebra::TpetraWrappers::Vector<double> u1;
    u1.reinit(complete_index_set(dim), MPI_COMM_WORLD);
    LinearAlgebra::TpetraWrappers::Vector<double> u2;
    ...
    LinearAlgebra::TpetraWrappers::SolverCG solver(solver_control);
