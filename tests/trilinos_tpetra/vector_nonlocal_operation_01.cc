...
// This test is like vector_nonlocal_addition_02, but checks a mixture of
// subsequent additions and insertions.
...
test()
{
  ...
  // Print the result after insertion on each process
  ...
  // Print the result after additions on each process
  ...
  //  0           |   =1,+1,=1     |   1.0,2.0,1.0
  //  1           |   =1,+1,=1     |   1.0,2.0,1.0
  //  2           |   =1,+1,+2,=1  |   1.0,4.0,1.0
  //  3           |   =2,+1,+2,=2  |   2.0,5.0,2.0
  //  4           |   =2,+2,=2     |   2.0,4.0,2.0
  //  5           |   =3,+2,+3=3   |   3.0,8.0,3.0
  //  6           |   =3,+3,=3     |   3.0,6.0,3.0
  //  7           |   =3,+3,=3     |   3.0,6.0,3.0
