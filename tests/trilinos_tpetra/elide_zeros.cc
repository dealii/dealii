 ...
 * 2534:     void
 * dealii::LinearAlgebra::TpetraWrappers::SparseMatrix<double>::add
 * (dealii::LinearAlgebra::TpetraWrappers::SparseMatrix<double>::size_type,
 * dealii::LinearAlgebra::TpetraWrappers:: SparseMatrix::size_type, const
 * size_type*, const TrilinosScalar*, bool, bool) 2534: The violated condition
 * was: 2534: nonlocal_matrix->RowMap()
 *           .LID(static_cast<LinearAlgebra::TpetraWrappers::types::int_type>(row))
 * != -1 2534: The name and call sequence of the exception was: 2534:
 * ExcMessage("Attempted to write into off-processor matrix row " "that has not
 * be specified as being writable upon " "initialization") 2534: Additional
 * Information: 2534: Attempted to write into off-processor matrix row that has
 * not be specified as being writable upon initialization 2534:
 * --------------------------------------------------------
 */
