...
private:
  ...
  LinearAlgebra::TpetraWrappers::SparseMatrix<double> reference_matrix;
  LinearAlgebra::TpetraWrappers::SparseMatrix<double> test_matrix;

  LinearAlgebra::TpetraWrappers::Vector<double> reference_rhs;
  LinearAlgebra::TpetraWrappers::Vector<double> test_rhs;
...
LaplaceProblem<dim>::setup_system()
{
  ...
  {
    LinearAlgebra::TpetraWrappers::SparsityPattern csp;
