...
{
  {
    ...
    deallog << "Next free particle index: " << particle_handler.get_next_free_particle_index()
            << std::endl;
    deallog << "Max particles per cell: " << particle_handler.n_global_max_particles_per_cell()
            << std::endl;
