...
{
  {
    ...
    for (auto particle = particle_handler.begin(); particle != particle_handler.end(); ++particle)
      deallog << "Before sort particle id " << particle->get_id() << " is in cell " << particle->get_surrounding_cell(tr) << std::endl;

    particle_handler.sort_particles_into_subdomains_and_cells();

    for (auto particle = particle_handler.begin(); particle != particle_handler.end(); ++particle)
      deallog << "After sort particle id " << particle->get_id() << " is in cell " << particle->get_surrounding_cell(tr) << std::endl;
    ...
    particle_handler.sort_particles_into_subdomains_and_cells();
    for (auto particle = particle_handler.begin(); particle != particle_handler.end(); ++particle)
      deallog << "After shift particle id " << particle->get_id() << " is in cell " << particle->get_surrounding_cell(tr) << std::endl;
