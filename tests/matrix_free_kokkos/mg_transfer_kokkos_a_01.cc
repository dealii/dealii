...
/**
 * Test Portable::MGTwoLevelTransfer for geometric global coarsening on an
 * adaptively refined mesh (identity scheme + hanging-node constraints).
 */
...
main(int argc, char **argv)
{
  ...
  // Portable transfer currently supports FE_Q through degree 4 for the
  // refined (embedding) scheme via CellTransferFactory.
