...
test()
{
  ...
  print(FESystem<dim>(FESystem<dim>(FE_RaviartThomas<dim>(0), 3, FE_Nedelec<dim>(0), 3),
                      2,
                      FE_Q<dim>(1),
                      3,
                      FE_Q<dim>(1),
  ...
  print(FESystem<dim>(FESystem<dim>(FE_RaviartThomas<dim>(1), 3, FE_Nedelec<dim>(1), 3),
                      2,
                      FE_Q<dim>(2),
                      3,
                      FE_Q<dim>(1),
