...
test()
{
  ...
  AssertThrow(BlockMask(12, false).represents_n_blocks(12) == true, ExcInternalError());
  AssertThrow(BlockMask(12, false).represents_n_blocks(13) == false, ExcInternalError());
