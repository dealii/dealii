          ...
          for(unsigned int q_point = 0; q_point < n_q_points; ++q_point)
            {
              ...
              if(dim == 3)
                {
                  total_curl_curl[0] += JxW_values[q_point]
                                        * (hessians[q_point][1][0][1]
                                           + hessians[q_point][2][0][2]
                                           - hessians[q_point][0][1][1]
                                           - hessians[q_point][0][2][2]);
                  total_curl_curl[1] += JxW_values[q_point]
                                        * (hessians[q_point][2][1][2]
                                           + hessians[q_point][0][0][1]
                                           - hessians[q_point][1][2][2]
                                           - hessians[q_point][1][0][0]);
                  total_curl_curl[2] += JxW_values[q_point]
                                        * (hessians[q_point][0][0][2]
                                           + hessians[q_point][1][1][2]
                                           - hessians[q_point][2][0][0]
                                           - hessians[q_point][2][1][1]);
                }
            }
