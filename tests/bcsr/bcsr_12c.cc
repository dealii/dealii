...
// similar as bcsr_12.cc but sets up ghost in such a way that they
...
test()
{
  ...
  // add ghosts in such a way that they span multiple blocks
  // add [13,19) on all processors
  locally_relevant_dofs.add_range(13, 19);
  if (myid == 0)
    locally_relevant_dofs.add_range(45, 56);
