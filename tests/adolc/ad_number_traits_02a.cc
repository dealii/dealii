...
main()
{
  ...
  print_info<AD::NumberTraits<std::complex<float>, AD::NumberTypes::adolc_taped>>();
  deallog.pop();
  ...
  print_info<AD::NumberTraits<std::complex<double>, AD::NumberTypes::adolc_taped>>();
  deallog.pop();
  ...
  print_info<AD::NumberTraits<std::complex<adouble>, AD::NumberTypes::adolc_taped>>();
  deallog.pop();
