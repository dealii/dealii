...
// plot PolynomialsNedelecNodal on the reference cell
...
template <int dim>
void
plot(const PolynomialsNedelecNodal<dim> &poly)
{
...
main()
{
  ...
  PolynomialsNedelecNodal<2> p20(0);
  PolynomialsNedelecNodal<2> p21(1);
  PolynomialsNedelecNodal<2> p22(2);

  plot(p20);
  plot(p21);
  plot(p22);

  PolynomialsNedelecNodal<3> p30(0);
  PolynomialsNedelecNodal<3> p31(1);
  PolynomialsNedelecNodal<3> p32(2);
