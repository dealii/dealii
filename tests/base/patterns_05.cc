...
int main()
{
  ...
  Patterns::List p5(Patterns::Double(), 2,2  ,","); // A std::complex<double>
  ...
  Patterns::List vp5(Patterns::List(Patterns::Double(), 2,2 ),0,10,";");
  ...
  deallog << "std::complex        : " << p5.to_string(l5) << std::endl;
  ...
  deallog << "List of std::complex         : " << vp5.to_string(vl5) << std::endl;
  ...
  vp5.to_value("1.0,2.0; 6.0,7.0", vl5);
