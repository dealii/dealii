...
{
  MGTransferPrebuilt<LinearAlgebra::distributed::Vector<double>> mg_transfer(mg_constrained_dofs);
  ...
  typedef PreconditionChebyshev<SparseMatrix<double>, LinearAlgebra::distributed::Vector<double>>
                                                                  Smoother;
