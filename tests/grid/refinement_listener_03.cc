...
test()
{
  ...
  boost::signals2::connection connections_1[5] = {
    ...
    tria_1.signals.any_change.connect(
      std::bind(&any_change_notification<dim, dim>, "tria_1", std::cref(tria_1)))};
  boost::signals2::connection connections_2[5] = {
    ...
    tria_2.signals.any_change.connect(
      std::bind(&any_change_notification<dim, dim>, "tria_2", std::cref(tria_2)))};
