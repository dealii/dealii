...
test()
{
  ...
  deallog << "local compatibility  v1-v2: " << v1.partitioners_are_compatible(*v2.get_partitioner())
  ...
  deallog << "local compatibility  v2-v3: " << v2.partitioners_are_compatible(*v3.get_partitioner())
  ...
  deallog << "local compatibility  v3-v4: " << v4.partitioners_are_compatible(*v3.get_partitioner())
  ...
  deallog << "local compatibility  v4-v5: " << v4.partitioners_are_compatible(*v5.get_partitioner())
  ...
  deallog << "local compatibility  v5-v6: " << v6.partitioners_are_compatible(*v5.get_partitioner())
