...
test()
{
  ...
  DEAL_II_AssertThrow(v(myid * 2 + 1) == myid * 4.0 + 2.0, ExcInternalError());
  ...
  DEAL_II_AssertThrow(v(myid * 2) == 0., ExcInternalError());
  DEAL_II_AssertThrow(v(myid * 2 + 1) == 0., ExcInternalError());
  ...
  if (myid == 0)
    v(1) = 2.;
  if (myid > 0)
    DEAL_II_AssertThrow(v(1) == 0., ExcInternalError());
  ...
  DEAL_II_AssertThrow(v(1) == 2.0, ExcInternalError());

  v = 0;
  DEAL_II_AssertThrow(v(1) == 0.0, ExcInternalError());
