...
// This test is a version of petsc_ts_03 that checks that the old but
// deprecated callback names can still be used without error. The test
// can be removed when the deprecated callbacks are removed.
