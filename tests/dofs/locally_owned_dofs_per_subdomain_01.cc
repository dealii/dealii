...
main()
{
  ...
  Assert(DoFTools::locally_owned_dofs_per_subdomain(hp_dof_handler).size() == n_subdomains,
         ExcDimensionMismatch(DoFTools::locally_owned_dofs_per_subdomain(hp_dof_handler).size(),
                              n_subdomains));
  Assert(DoFTools::locally_relevant_dofs_per_subdomain(hp_dof_handler).size() == n_subdomains,
         ExcDimensionMismatch(DoFTools::locally_relevant_dofs_per_subdomain(hp_dof_handler).size(),
                              n_subdomains));
