...
check(const Triangulation<dim> &tria)
{
  ...
  FEFaceValues<dim>    fe_face_values(fe, q_face, update_normal_vectors | update_JxW_values);
  FESubfaceValues<dim> fe_subface_values(fe, q_face, update_normal_vectors | update_JxW_values);
