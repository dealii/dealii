            ...
            const Vector<double>  &v_cell)
{
  ...
  data_out.add_data_vector (v_node, "node_data", DataOut_DoFData<DoFHandler<dim>,dim,dim>::type_dof_data);
  data_out.add_data_vector (v_cell, "cell_data", DataOut_DoFData<DoFHandler<dim>,dim,dim>::type_cell_data);
