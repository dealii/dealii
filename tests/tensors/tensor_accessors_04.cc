...
main()
{
  ...
  // Contract rank 1, rank 2, rank 1:
  {
    ...
    deallog << "right:  " << right << std::endl;
    deallog << "Result: " << TensorAccessors::contract3<1, 1, 5, int>(left, middle, right)
            << std::endl;
    deallog << std::endl;
  ...
  // Contract rank 2, rank 3, rank 1:
  {
    ...
    deallog << "right:  " << right << std::endl;
    deallog << "Result: " << TensorAccessors::contract3<2, 1, 5, int>(middle, middle3, right)
            << std::endl;
    deallog << std::endl;
    //     manually verified to be equal to the old implementation
  ...
  // Contract rank 1, rank 3, rank 2:
  {
    ...
    deallog << "Result: " << TensorAccessors::contract3<1, 2, 5, int>(left, middle3, middle)
            << std::endl;
    deallog << std::endl;
    //     manually verified to be equal to the old implementation
  ...
  // Contract rank 2, rank 4, rank 2:
  {
    ...
    deallog << "right:  " << middle << std::endl;
    deallog << "Result: " << TensorAccessors::contract3<2, 2, 5, long int>(left2, middle4, middle)
            << std::endl;
    deallog << std::endl;
    //     manually verified to be equal to the old implementation
