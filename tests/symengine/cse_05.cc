...
// Another test for the optimizer. Here we compare the output of from
    ...
    for (unsigned int r = 0; r < n_evals; ++r)
      {
        ...
        const std::vector<double> result = optimiser.get_evaluated_functions();
