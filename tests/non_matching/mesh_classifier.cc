...
//
// This function is specialized for each dimension below.
template <int dim>
void
...
template <>
void
setup_intersected_Q2_positive_coefficients<1>(Vector<double> &level_set)
{
...
setup_intersected_Q2_positive_coefficients<2>(Vector<double> &level_set)
{
  ...
  // Listing entries left to right and top to bottom.
  level_set(0) = 100 * delta;
  level_set(6) = delta;
  level_set(1) = delta;
  level_set(4) = .5;
