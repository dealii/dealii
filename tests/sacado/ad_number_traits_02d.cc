...
main()
{
  ...
  print_info<AD::NumberTraits<std::complex<Sacado::Rad::ADvar<Sacado::Fad::DFad<float>>>,
                              AD::NumberTypes::sacado_rad_dfad>>();
  deallog.pop();
#endif
  ...
  print_info<AD::NumberTraits<std::complex<Sacado::Rad::ADvar<Sacado::Fad::DFad<double>>>,
                              AD::NumberTypes::sacado_rad_dfad>>();
  deallog.pop();
#endif
