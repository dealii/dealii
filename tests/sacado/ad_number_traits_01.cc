...
main ()
{
  ...
  AD::NumberTraits<Sacado::Fad::DFad<Sacado::Fad::DFad<float> >,AD::NumberTypes::sacado_dfad_dfad>();
  AD::NumberTraits<std::complex< Sacado::Fad::DFad<Sacado::Fad::DFad<float> > >,AD::NumberTypes::sacado_dfad_dfad>();
  AD::NumberTraits<Sacado::Fad::DFad<Sacado::Fad::DFad<double> >,AD::NumberTypes::sacado_dfad_dfad>();
  AD::NumberTraits<std::complex< Sacado::Fad::DFad<Sacado::Fad::DFad<double> > >,AD::NumberTypes::sacado_dfad_dfad>();
  ...
  AD::NumberTraits<Sacado::Rad::ADvar<Sacado::Fad::DFad<float> >,AD::NumberTypes::sacado_rad_dfad>();
  AD::NumberTraits<Sacado::Rad::ADvar<Sacado::Fad::DFad<double> >,AD::NumberTypes::sacado_rad_dfad>();
  ...
  AD::NumberTraits<std::complex< Sacado::Rad::ADvar<Sacado::Fad::DFad<float> > >,AD::NumberTypes::sacado_rad_dfad>();
  AD::NumberTraits<std::complex< Sacado::Rad::ADvar<Sacado::Fad::DFad<double> > >,AD::NumberTypes::sacado_rad_dfad>();
#endif
