...
int main()
{
  ...
  const double dg_dx_ad = (x_ad.adj() - df_dx_ad);  // dg/dx ; Note: Accumulation of partial derivatives
  const double dg_dy_ad = (y_ad.adj() - df_dy_ad);  // dg/dy ; Note: Accumulation of partial derivatives
  ...
  const double dh_dx_ad = (x_ad.adj() - dg_dx_ad - df_dx_ad);  // dh/dx ; Note: Accumulation of partial derivatives
  const double dh_dy_ad = (y_ad.adj() - dg_dy_ad - df_dy_ad);  // dh/dy ; Note: Accumulation of partial derivatives
