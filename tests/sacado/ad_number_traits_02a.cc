...
main ()
{
  ...
  print_info<AD::NumberTraits<std::complex<float>,AD::NumberTypes::sacado_dfad> >();
  deallog.pop();
  ...
  print_info<AD::NumberTraits<std::complex<double>,AD::NumberTypes::sacado_dfad> >();
  deallog.pop();

  deallog.push("Sacado::Fad::DFad<float>");
  print_info<AD::NumberTraits<Sacado::Fad::DFad<float>,AD::NumberTypes::sacado_dfad> >();
  deallog.pop();

  deallog.push("std::complex< Sacado::Fad::DFad<float> >");
  print_info<AD::NumberTraits<std::complex< Sacado::Fad::DFad<float> >,AD::NumberTypes::sacado_dfad> >();
  deallog.pop();

  deallog.push("Sacado::Fad::DFad<double>");
  print_info<AD::NumberTraits<Sacado::Fad::DFad<double>,AD::NumberTypes::sacado_dfad> >();
  deallog.pop();

  deallog.push("std::complex< Sacado::Fad::DFad<double> >");
  print_info<AD::NumberTraits<std::complex< Sacado::Fad::DFad<double> >,AD::NumberTypes::sacado_dfad> >();
  deallog.pop();
