...
main ()
{
  ...
  deallog.push("Extracted");
  {
    ...
    const ADScalarType d2rda2  = AD::internal::ExtractData<ADDerivativeType>::directional_derivative(drda_ad,0); // d^2r/da^2
    const ADScalarType d2rdadb = AD::internal::ExtractData<ADDerivativeType>::directional_derivative(drda_ad,1); // d^2r/dadb
    const ADScalarType d2rdbda = AD::internal::ExtractData<ADDerivativeType>::directional_derivative(drdb_ad,0); // d^2r/dbda
    const ADScalarType d2rdb2  = AD::internal::ExtractData<ADDerivativeType>::directional_derivative(drdb_ad,1); // d^2/db^2
