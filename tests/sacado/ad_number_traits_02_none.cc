...
// Test that all of the floating point number traits return the correct
// information
...
main()
{
  ...
  deallog.push("float");
  print_info<AD::NumberTraits<float, AD::NumberTypes::none>>();
  deallog.pop();

  deallog.push("std::complex<float>");
  print_info<AD::NumberTraits<std::complex<float>, AD::NumberTypes::none>>();
  deallog.pop();

  deallog.push("double");
  print_info<AD::NumberTraits<double, AD::NumberTypes::none>>();
  deallog.pop();

  deallog.push("std::complex<double>");
  print_info<AD::NumberTraits<std::complex<double>, AD::NumberTypes::none>>();
  deallog.pop();
  ...
  deallog.push("float");
  print_info<AD::ADNumberTraits<float>>();
  deallog.pop();

  deallog.push("std::complex<float>");
  print_info<AD::ADNumberTraits<std::complex<float>>>();
  deallog.pop();

  deallog.push("double");
  print_info<AD::ADNumberTraits<double>>();
  deallog.pop();

  deallog.push("std::complex<double>");
  print_info<AD::ADNumberTraits<std::complex<double>>>();
  deallog.pop();
