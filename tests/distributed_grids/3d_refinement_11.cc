...
// 3D counterpart of 2d_refinement_09
int main (int argc, char *argv[])
{
  ...
  deallog.push("3d");
  TriaTest<3> tria_test(dealii::Triangulation<3>::limit_level_difference_at_vertices);
  tria_test.run();
  deallog.pop();

  // {
  //   {
  //     TypeTria triangulation (MPI_COMM_WORLD,
  ...
  //                                                p1,
  //                                                p2);
  //     std::string name("FourTrees");
  //     run(triangulation, name);
  //   }
