 ...
 * This test is similar to mesh_interface_tria_05, except that now multiple
 * initial local refinement cycles are performed.
 *
 ...
 *     - Hanging vertex constraints are enforced automatically ( at the end of
 *       MesquiteMeshInterface::execute())
