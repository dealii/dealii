//----------------------------  vectors_boundary_rhs_hp_03.cc  ---------------------------
//    $Id: vectors_boundary_rhs_hp_03.cc 14279 2006-12-28 04:53:24Z bangerth $
//    Version: $Name$ 
//
...
// like deal.II/vectors_boundary_rhs_03, but for hp objects. here, each hp object has only a
// single component, so we expect exactly the same output as for the old test.
// vectors_boundary_rhs_hp_03_hp tests for different finite elements
