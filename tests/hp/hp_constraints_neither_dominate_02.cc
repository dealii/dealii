                ...
                const FiniteElement<dim> &fe_common)
{
  ...
  deallog << "hp-ref: "<<fe_0.get_name()<< " vs "<<fe_1.get_name()<<" vs " << fe_2.get_name() <<" with "<< fe_common.get_name()<<std::endl;
    ...
    {
      {
        ...
        test2cells<dim>(FESystem<dim>(FE_Q<dim>(2),1,
                                      FE_Q<dim>(1),1,
                                      FE_Q<dim>(1),1),
        ...
        test2cells<dim>(FESystem<dim>(FE_Q<dim>(1),1,
                                      FE_Q<dim>(1),1,
                                      FE_Q<dim>(1),1),
                        FESystem<dim>(FE_Q<dim>(1),1,
                                      FE_Q<dim>(2),1,
