...
// This test checks the assembly of a PSBLAS sparse matrix when matrix is
// constructed from a PSBLAS sparsity pattern.
...
main(int argc, char **argv)
{
  ...
  deallog << "Process " << Utilities::MPI::this_mpi_process(mpi_communicator)
          ...
          << " has assembled a matrix of " << psblas_matrix.m() << " x "
