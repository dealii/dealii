...
test()
{
  ...
  deallog << "ghosted value: " << get_real_assert_zero_imag(v(1)) << " (should be 2.0)"
          << std::endl;
  v = 0;
  deallog << "ghosted value: " << get_real_assert_zero_imag(v(1)) << " (should be 0.0)"
          << std::endl;
  v = 42.1;
  deallog << "ghosted value: " << get_real_assert_zero_imag(v(1)) << " (should be 42.1)"
          << std::endl;
