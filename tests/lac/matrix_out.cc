  ...
  if (true)
    {
      ...
      MatrixOut matrix_out;
      matrix_out.build_patches(sparse_matrix, "sparse_matrix", MatrixOut::Options(true));
  ...
  if (true)
    {
      ...
      MatrixOut matrix_out;
      matrix_out.build_patches(full_matrix, "collated_matrix", MatrixOut::Options(false, 4));
