...
test()
{
  ...
  DEAL_II_Assert(is_serial_vector<dealii::Vector<double>>::value == true,
                 ExcInternalError());
  ...
  DEAL_II_Assert(is_serial_vector<dealii::BlockVector<double>>::value == true,
                 ExcInternalError());
  ...
  // working
  DEAL_II_Assert(
    is_serial_vector<dealii::LinearAlgebra::Vector<double>>::value == true,
    ExcInternalError());
  ...
  // working
  DEAL_II_Assert(is_serial_vector<
  ...
  DEAL_II_Assert(
    is_serial_vector<
      dealii::LinearAlgebra::distributed::BlockVector<double>>::value == false,
    ExcInternalError());
