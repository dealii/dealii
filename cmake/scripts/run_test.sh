...
#
# Usage:
#   run_test.sh run TEST_FULL RUN_COMMAND DIFF_EXECUTABLE DIFF_EXECUTABLE COMPARISON_FILE
#   run_test.sh diff TEST_FULL RUN_COMMAND DIFF_EXECUTABLE DIFF_EXECUTABLE COMPARISON_FILE
#
