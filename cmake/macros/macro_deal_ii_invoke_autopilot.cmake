...
MACRO(DEAL_II_INVOKE_AUTOPILOT)
  ...
  IF(CMAKE_SYSTEM_NAME MATCHES "(CYGWIN|Windows)")
    ...
    IF(CMAKE_SYSTEM_NAME MATCHES "Windows")
      SET(_delim ";")
    ENDIF()
    FILE(WRITE ${deal.II_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/run_target.cmake
    ...
    SET(_command
      ${CMAKE_COMMAND} -P ${deal.II_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/run_target.cmake
      )
  ...
  IF(CMAKE_SYSTEM_NAME MATCHES "Darwin")
    IF(DEFINED OSX_CERTIFICATE_NAME)
      ADD_CUSTOM_COMMAND(OUTPUT ${deal.II_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/${TARGET}.signed
        COMMAND codesign -f -s ${OSX_CERTIFICATE_NAME} ${TARGET}
        COMMAND ${CMAKE_COMMAND} -E touch ${deal.II_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/${TARGET}.signed
        COMMENT "Digitally signing ${TARGET}"
        DEPENDS ${TARGET}
        VERBATIM
        )
      ADD_CUSTOM_TARGET(sign ALL
        DEPENDS ${deal.II_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/${TARGET}.signed
        )
  ...
  IF(${DEAL_II_BUILD_TYPE} MATCHES "Debug")
    ADD_CUSTOM_TARGET(debug
      COMMAND ${CMAKE_COMMAND} -DCMAKE_BUILD_TYPE=Debug ${deal.II_SOURCE_DIR}
  ...
  IF(${DEAL_II_BUILD_TYPE} MATCHES "Release")
    ADD_CUSTOM_TARGET(release
      COMMAND ${CMAKE_COMMAND} -DCMAKE_BUILD_TYPE=Release ${deal.II_SOURCE_DIR}
      COMMAND ${CMAKE_COMMAND} -E echo "***"
...
#      ${_make_command} release        - to switch the build type to 'Release'\n"
  ...
  ADD_CUSTOM_TARGET(distclean
    COMMAND ${CMAKE_COMMAND} --build ${deal.II_BINARY_DIR} --target clean
    COMMAND ${CMAKE_COMMAND} --build ${deal.II_BINARY_DIR} --target runclean
  ...
  FILE(WRITE ${deal.II_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/print_usage.cmake
"MESSAGE(
\"###
#
...
")
  IF(NOT CMAKE_GENERATOR MATCHES "Ninja")
    FILE(APPEND ${deal.II_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/print_usage.cmake
...
###\")"
  ...
  ADD_CUSTOM_TARGET(info
    COMMAND ${CMAKE_COMMAND} -P ${deal.II_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/print_usage.cmake
    )

  # Print this message once:
  IF(NOT USAGE_PRINTED)
    INCLUDE(${deal.II_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/print_usage.cmake)
