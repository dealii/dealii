...
function(copy_target_properties _destination_target)
  ...
  while(NOT "${_source_targets}" STREQUAL "")
    ...
    get_target_property(_values ${_entry} INTERFACE_COMPILE_FEATURES)
    if(NOT "${_values}" MATCHES "-NOTFOUND")
      strip_known_generator_expressions(_values)
      list(APPEND _compile_features ${_values})
    endif()
  ...
  if(NOT "${_compile_features}" STREQUAL "")
    remove_duplicates(_compile_features REVERSE)
    message(STATUS "    COMPILE_FEATURES ${_compile_features}")
    target_compile_features(${_destination_target} INTERFACE ${_compile_features})
  endif()
