...
set(_itk_requested_components
  ITKIONIFTI
  ITKIOPNG
  ITKIOJPEG
)

find_package(ITK QUIET COMPONENTS ${_itk_requested_components} HINTS ${ITK_DIR})
if(ITK_FOUND)
  if(ITK_VERSION VERSION_LESS 5.3.0)
    message(STATUS "Found ITK version ${ITK_VERSION} but the minimum version supported is 5.3.0")
    unset(ITK_FOUND)
  endif()
endif()
