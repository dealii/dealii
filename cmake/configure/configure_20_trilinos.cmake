...
macro(feature_trilinos_find_external var)
  ...
  if(TRILINOS_FOUND)
    ...
    if (DEAL_II_TRILINOS_WITH_EPETRA)
      foreach(_module
        Amesos Anasazi Epetra Ifpack AztecOO Teuchos ML
      )
    ...
    if(NOT ${var})
      set(DEAL_II_TRILINOS_WITH_EPETRA FALSE)
      set(DEAL_II_TRILINOS_WITH_TPETRA FALSE)
      unset(DEAL_II_TRILINOS_WITH_TPETRA_INST_COMPLEX_DOUBLE CACHE)
      unset(DEAL_II_TRILINOS_WITH_TPETRA_INST_COMPLEX_FLOAT CACHE)
      unset(DEAL_II_TRILINOS_WITH_TPETRA_INST_DOUBLE CACHE)
      unset(DEAL_II_TRILINOS_WITH_TPETRA_INST_FLOAT CACHE)
      unset(DEAL_II_TRILINOS_WITH_TPETRA_MUELU CACHE)
    endif()
