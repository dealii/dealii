...
|-----------------------|------------|------------------------|----------------------------|--------------------------------------------------|----------------------------------------------------------|------------------------------------------------------------------------------------|
| release-serial        | x64        | jammy, noble, resolute | g++ 11.4.0, 13.3.0, 15.2.0 | -Werror -std=c++20                               |                                                          | container:dealii/dependencies                                                      |
| debug-parallel        | x64, arm64 | jammy, noble, resolute | g++ 11.4.0, 13.3.0, 15.2.0 | -Werror -std=c++20 -mno-outline-atomics          | OpenMPI, CGAL, HDF5, NetCDF, Metis, PETSc, Trilinos, VTK | container:dealii/dependencies                                                      |
| debug-parallel-tpetra | x64        | jammy, noble, resolute | g++ 11.4.0, 13.3.0, 15.2.0 | -std=c++20                                       | OpenMPI, p4est, Trilinos                                 | DEAL_II_WITH_64BIT_INDICES=ON, container:dealii/dependencies                       |
| debug-intel-oneapi    | x64        | jammy                  | icpx 2026.1.0              | -Werror -Wno-error=tautological-constant-compare | IntelMPI, MKL, TBB                                       | container:intel/oneapi:2026.1.0-devel-ubuntu22.04                                  |
