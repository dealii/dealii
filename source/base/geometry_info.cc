...
const std::array<unsigned int, GeometryInfo<0>::vertices_per_cell> GeometryInfo<0>::ucd_to_deal = {
  {0}};

const std::array<unsigned int, GeometryInfo<0>::vertices_per_cell> GeometryInfo<0>::dx_to_deal = {
  {0}};
