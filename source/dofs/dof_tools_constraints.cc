                    ...
                    case FiniteElementDomination::neither_element_dominates:
                      {
                        ...
                        // dominating FE among sub faces. We could loop over
                        // sub faces to find the needed FE index. However, this
                        // will not work in the case when
                        ...
                        // FECollection with fe_indices of sub faces.
