...
namespace hp
{
    ...
    const unsigned int q_index)
  {
    ...
    // of indices
    if (fe_values_table(present_fe_values_index).get() DEAL_II_EQUALS nullptr)
...
namespace hp
{
    ...
    const unsigned int                                       fe_index)
  {
    ...
    if (real_q_index DEAL_II_EQUALS numbers::invalid_unsigned_int)
      {
    ...
    if (real_mapping_index DEAL_II_EQUALS numbers::invalid_unsigned_int)
      {
    ...
    if (real_fe_index DEAL_II_EQUALS numbers::invalid_unsigned_int)
