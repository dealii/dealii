  ...
  switch (dim)
    {
      ...
      case 3:
        ...
        if (this->reference_cell().face_reference_cell(face_no) == ReferenceCells::Quadrilateral)
          return {
            ...
            this->n_dofs_per_face(face_no)};
        else if (this->reference_cell().face_reference_cell(face_no) == ReferenceCells::Triangle)
          return {
