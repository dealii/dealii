...
namespace internal
{
  ...
  namespace MappingQ1
  {
    namespace
    {
      ...
      Point<3>
      transform_real_to_unit_cell(
        const std::array<Point<spacedim>,
                         GeometryInfo<3>::vertices_per_cell>& /*vertices*/,
        const Point<spacedim>& /*p*/)
      {
  ...
  namespace MappingQGenericImplementation
  {
    namespace
    {
      ...
      compute_support_point_weights_cell(const unsigned int polynomial_degree)
      {
        ...
        dealii::Table<2, double> output(
          quadrature.size() - GeometryInfo<dim>::vertices_per_cell,
                      ...
                      switch(dim)
                        {
                          ...
                          case 2:
                            ...
                            break;
                          case 3:
                            output_data.boundary_forms[i] = cross_product_3d(
                              data.aux[0][i], data.aux[1][i]);
                            break;
                          default:
                            Assert(false, ExcNotImplemented());
                        }
                        ...
                        if(dim == 2)
                          {
                            ...
                            // and the cell normal:
                            output_data.boundary_forms[point]
                              = cross_product_3d(data.aux[0][point],
                                                 cell_normal);
                          }
                      }
                  }
