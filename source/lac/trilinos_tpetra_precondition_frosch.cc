...
#    ifdef HAVE_TPETRA_INST_FLOAT
    ...
    template void
    PreconditionFROSch<float, dealii::MemorySpace::Host>::initialize<2>(
      const SparseMatrix<float, dealii::MemorySpace::Host> &,
      const DoFHandler<2> &,
      const PreconditionFROSch<float, dealii::MemorySpace::Host>::AdditionalData
        &);
    PreconditionFROSch<float, dealii::MemorySpace::Host>::initialize<3>(
      const SparseMatrix<float, dealii::MemorySpace::Host> &,
      const DoFHandler<3> &,
      const PreconditionFROSch<float, dealii::MemorySpace::Host>::AdditionalData
        &);
...
#    ifdef HAVE_TPETRA_INST_DOUBLE
    ...
    template void
    PreconditionFROSch<double, dealii::MemorySpace::Host>::initialize<2>(
