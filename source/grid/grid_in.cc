      ...
      for (unsigned int e = 0; e < n_elements; ++e)
        {
          ...
          else if ((object_name == "tri") || (object_name == "quad"))
            {
              if (dim == 2)
                {
                  cells.emplace_back();
          ...
          else if ((object_name == "tet") || (object_name == "prism"))
            {
              if (dim == 3)
                {
                  cells.emplace_back();
