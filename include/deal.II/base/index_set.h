...
public:
   ...
   */
  void
  add_range (const size_type begin,
             const size_type end);
  ...
  void
  add_indices (const ForwardIterator &begin,
   ...
   */
  void
  add_indices(const IndexSet &other,
   ...
   */
  IndexSet
  get_view (const size_type begin,
...
private:
  ...
  struct Range
  {
    ...
    static bool
    nth_index_compare (const IndexSet::Range &x,
