...
namespace Utilities
{
  ...
  namespace MPI
  {
     ...
     * `true` if all operands are `true` and returns `false` otherwise. If the
     * provided value @p t corresponds to `0` in its associated data type `T`,
     * it will be interpreted as `false`, and `true` otherwise. Data type `T`
     * must be of type `integral`, i.e., `bool`, `char`, `short`, `int`, `long`,
