...
namespace Functions
{
  ...
  public:
    ...
    virtual void
    vector_gradient(const Point<dim> &p, std::vector<Tensor<1, dim>> &gradient) const override;
    virtual void
  ...
  public:
    ...
    virtual void
    vector_gradient_list(const std::vector<Point<dim>> &,
  ...
  public:
    ...
    virtual void
    vector_gradient_list(const std::vector<Point<2>> &,
