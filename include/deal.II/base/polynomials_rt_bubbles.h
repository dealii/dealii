...
#ifndef dealii__polynomials_rt_bubbles_h
#define dealii__polynomials_rt_bubbles_h
 ...
 *  @f}
 *
 * The total dimension of the space <i>V<sub>k</sub> = d*(k+1)^d</i>, where <i>d</i> is the
 * physical dimension. Note that the lowest order of these polynomials is 1.
 * </dl>
 * @ingroup Polynomials
...
private:
  ...
  /**
  * An object representing the polynomial space for a single component of the
  * Raviart-Thomas part of the space. It can be re-used by rotation of the
