...
template <int dim, typename Number>
void
MGTransferMatrixFree<dim, Number>::initialize_internal_transfer(
...
MGTransferMatrixFree<dim, Number>::get_dof_handler_fine() const
{
...
template <int dim, typename Number>
void
MGTransferMatrixFree<dim, Number>::prolongate(const unsigned int to_level,
                                              VectorType        &dst,
...
template <int dim, typename Number>
void
MGTransferMatrixFree<dim, Number>::assert_dof_handler(
...
template <int dim, typename Number>
inline unsigned int
MGTransferMatrixFree<dim, Number>::min_level() const
{
...
template <int dim, typename Number>
inline unsigned int
MGTransferMatrixFree<dim, Number>::max_level() const
{
