...
DoFAccessor<structdim, DoFHandlerType, level_dof_access>::child(const unsigned int i) const
{
  ...
  TriaIterator<TriaAccessor<structdim, DoFHandlerType::dimension, DoFHandlerType::space_dimension>>
    t =
      TriaAccessor<structdim, DoFHandlerType::dimension, DoFHandlerType::space_dimension>::child(i);
...
namespace internal
{
  namespace DoFAccessorImplementation
  {
    ...
    struct Implementation
    {
      ...
      {
        return dof_handler.levels[obj_level]->get_dof_index(obj_index, fe_index, local_index);
      }
      ...
      {
        dof_handler.faces->lines.set_dof_index(
          dof_handler, obj_index, fe_index, local_index, global_index, obj_level);
      }
                          ...
                          const std::integral_constant<int, structdim> &)
      {
        ...
        Assert((dim == structdim ?
                  TriaRawIterator<dealii::CellAccessor<dim, spacedim>>(
                    ...
                    ->used() :
                  (structdim == 1 ?
                     typename internal::TriangulationImplementation::Iterators<dim, spacedim>::
                       raw_line_iterator(&dof_handler.get_triangulation(), obj_level, obj_index)
                         ->used() :
                     true)) == true,
      ...
      fe_index_is_active(const dealii::hp::DoFHandler<1, spacedim> &dof_handler,
                         ...
                         const std::integral_constant<int, 1> &)
      {
        return dof_handler.levels[obj_level]->fe_index_is_active(obj_index, fe_index);
      }
      ...
      n_active_fe_indices(const dealii::hp::DoFHandler<2, spacedim> &dof_handler,
                          ...
                          const std::integral_constant<int, 1> &)
      {
        return dof_handler.faces->lines.n_active_fe_indices(dof_handler, obj_index);
      }
      ...
      nth_active_fe_index(const dealii::hp::DoFHandler<2, spacedim> &dof_handler,
                          ...
                          const std::integral_constant<int, 1> &)
      {
        return dof_handler.faces->lines.nth_active_fe_index(dof_handler, obj_level, obj_index, n);
      }
      ...
      n_active_fe_indices(const dealii::hp::DoFHandler<3, spacedim> &dof_handler,
                          ...
                          const std::integral_constant<int, 2> &)
      {
        return dof_handler.faces->quads.n_active_fe_indices(dof_handler, obj_index);
      }
      ...
      nth_active_fe_index(const dealii::hp::DoFHandler<3, spacedim> &dof_handler,
                          ...
                          const std::integral_constant<int, 2> &)
      {
        return dof_handler.faces->quads.nth_active_fe_index(dof_handler, obj_level, obj_index, n);
      }
                           ...
                           const types::global_dof_index      global_index)
      {
        ...
        dof_handler.vertex_dofs[vertex_index * dof_handler.get_fe().dofs_per_vertex + local_index] =
          global_index;
      }
                           ...
                           const types::global_dof_index          global_index)
      {
        ...
        Assert(local_index < dof_handler.get_fe(fe_index).dofs_per_vertex,
               ExcIndexRange(local_index, 0, dof_handler.get_fe(fe_index).dofs_per_vertex));
        Assert(fe_index < dof_handler.fe_collection.size(), ExcInternalError());
        Assert(dof_handler.vertex_dof_offsets[vertex_index] != numbers::invalid_unsigned_int,
        ...
        while (true)
          {
            ...
            Assert(this_fe_index != numbers::invalid_dof_index, ExcInternalError());
            Assert(this_fe_index < dof_handler.fe_collection.size(), ExcInternalError());
                           ...
                           const unsigned int                       local_index)
      {
        ...
        return dof_handler
          .vertex_dofs[vertex_index * dof_handler.get_fe().dofs_per_vertex + local_index];
      }
                           ...
                           const unsigned int                           local_index)
      {
        ...
        Assert(vertex_index < dof_handler.vertex_dof_offsets.size(),
               ExcIndexRange(vertex_index, 0, dof_handler.vertex_dof_offsets.size()));
        Assert(dof_handler.vertex_dof_offsets[vertex_index] != numbers::invalid_unsigned_int,
               ExcMessage("This vertex is unused and has no DoFs associated with it"));
        ...
        while (true)
          {
            ...
            Assert((*pointer) < std::numeric_limits<types::global_dof_index>::max(),
                   ExcInternalError());
            const types::global_dof_index this_fe_index = *pointer;
                                 ...
                                 const unsigned int                           n)
      {
        ...
        Assert(n < n_active_vertex_fe_indices(dof_handler, vertex_index),
               ExcIndexRange(n, 0, n_active_vertex_fe_indices(dof_handler, vertex_index)));
      ...
      template <typename DoFHandlerType, bool level_dof_access>
      static void
      set_mg_dof_indices(const dealii::DoFAccessor<3, DoFHandlerType, level_dof_access> &accessor,
                         const int                                                       level,
                         const std::vector<types::global_dof_index> &dof_indices,
                         const unsigned int                          fe_index)
      {
        ...
        for (unsigned int line = 0; line < GeometryInfo<3>::lines_per_cell; ++line)
          for (unsigned int dof = 0; dof < fe.dofs_per_line; ++dof)
            accessor.line(line)->set_mg_dof_index(
              level,
              fe.adjust_line_dof_index_for_line_orientation(dof, accessor.line_orientation(line)),
              *next++);
        ...
        for (unsigned int quad = 0; quad < GeometryInfo<3>::quads_per_cell; ++quad)
          for (unsigned int dof = 0; dof < fe.dofs_per_quad; ++dof)
            accessor.quad(quad)->set_mg_dof_index(
              level,
              fe.adjust_quad_dof_index_for_face_orientation(dof,
      ...
      sort_indices(const types::global_dof_index *v_begin, const types::global_dof_index *v_end)
      {
        ...
        std::sort(idx.begin(), idx.end(), [&v_begin](unsigned int i1, unsigned int i2) {
      ...
      extract_subvector_to(const LinearAlgebra::EpetraWrappers::Vector &values,
                           ...
                           ForwardIterator                              local_values_begin)
      {
        std::vector<unsigned int> sorted_indices_pos = sort_indices(cache_begin, cache_end);
                                                              ...
                                                              const unsigned int fe_index) const
{
  ...
  return dealii::internal::DoFAccessorImplementation::Implementation::get_dof_index(
    *this->dof_handler,
    this->level(),
    this->present_index,
    fe_index,
...
{
  // access the respective DoF
  return dealii::internal::DoFAccessorImplementation::Implementation::n_active_fe_indices(
    *this->dof_handler, this->level(), this->present_index, std::integral_constant<int, dim>());
}
...
{
  // access the respective DoF
  return dealii::internal::DoFAccessorImplementation::Implementation::nth_active_fe_index(
    *this->dof_handler, this->level(), this->present_index, n, std::integral_constant<int, dim>());
}
...
{
  // access the respective DoF
  return dealii::internal::DoFAccessorImplementation::Implementation::fe_index_is_active(
    *this->dof_handler,
    this->level(),
    this->present_index,
    fe_index,
  ...
  const unsigned int fe_index) const
{
  ...
  return dealii::internal::DoFAccessorImplementation::Implementation::mg_vertex_dof_index(
  ...
  const unsigned int            fe_index) const
{
  ...
  return dealii::internal::DoFAccessorImplementation::Implementation::set_mg_vertex_dof_index(
...
template <int dim, typename DoFHandlerType, bool level_dof_access>
inline const FiniteElement<DoFHandlerType::dimension, DoFHandlerType::space_dimension> &
...
namespace internal
{
  namespace DoFAccessorImplementation
  {
      ...
      for (unsigned int line = 0; line < 4; ++line)
        for (unsigned int d = 0; d < dofs_per_line; ++d)
          *next++ = accessor.line(line)->dof_index(
            accessor.get_fe(fe_index).adjust_line_dof_index_for_line_orientation(
      ...
      for (unsigned int quad = 0; quad < 6; ++quad)
        for (unsigned int d = 0; d < dofs_per_quad; ++d)
          *next++ = accessor.quad(quad)->dof_index(
            accessor.get_fe(fe_index).adjust_quad_dof_index_for_face_orientation(
              d,
              accessor.face_orientation(quad),
              accessor.face_flip(quad),
              accessor.face_rotation(quad)),
    ...
    template <typename DoFHandlerType, bool level_dof_access>
    void
    get_mg_dof_indices(const dealii::DoFAccessor<1, DoFHandlerType, level_dof_access> &accessor,
                       const int                                                       level,
                       std::vector<types::global_dof_index> &                          dof_indices,
                       const unsigned int                                              fe_index)
    {
    ...
    template <typename DoFHandlerType, bool level_dof_access>
    void
    get_mg_dof_indices(const dealii::DoFAccessor<3, DoFHandlerType, level_dof_access> &accessor,
                       const int                                                       level,
                       std::vector<types::global_dof_index> &                          dof_indices,
                       const unsigned int                                              fe_index)
    {
  ...
  const unsigned int                    fe_index) const
{
  ...
  internal::DoFAccessorImplementation::get_mg_dof_indices(*this, level, dof_indices, fe_index);
}
...
namespace internal
{
  namespace DoFAccessorImplementation
  {
    ...
    inline typename dealii::internal::DoFHandlerImplementation::
      ...
      get_quad(
        const dealii::Triangulation<DoFHandlerType::dimension, DoFHandlerType::space_dimension> *,
        unsigned int /*index*/,
        DoFHandlerType *)
    {}
    ...
    inline typename dealii::internal::DoFHandlerImplementation::
      ...
      get_quad(const dealii::Triangulation<2, 2> *, unsigned int, dealii::DoFHandler<2, 2> *)
    {
      Assert(false, ExcNotImplemented());
    ...
    inline typename dealii::internal::DoFHandlerImplementation::
      ...
      get_quad(const dealii::Triangulation<2, 3> *, unsigned int, dealii::DoFHandler<2, 3> *)
    {
      Assert(false, ExcNotImplemented());
      return typename dealii::internal::DoFHandlerImplementation::
    ...
    inline typename dealii::internal::DoFHandlerImplementation::
      ...
      get_quad(const dealii::Triangulation<2, 2> *, unsigned int, dealii::hp::DoFHandler<2, 2> *)
    {
      Assert(false, ExcNotImplemented());
      return typename dealii::internal::DoFHandlerImplementation::
        Iterators<dealii::hp::DoFHandler<2, 2>, level_dof_access>::line_iterator();
    }

    template <bool level_dof_access>
    inline typename dealii::internal::DoFHandlerImplementation::
      Iterators<dealii::hp::DoFHandler<2, 3>, level_dof_access>::quad_iterator
      get_quad(const dealii::Triangulation<2, 3> *, unsigned int, dealii::hp::DoFHandler<2, 3> *)
    {
      Assert(false, ExcNotImplemented());
      return typename dealii::internal::DoFHandlerImplementation::
        Iterators<dealii::hp::DoFHandler<2, 3>, level_dof_access>::line_iterator();
    }
  } // namespace DoFAccessorImplementation
} // namespace internal
  ...
  if (structdim == 1)
    {
      ...
      return typename dealii::internal::DoFHandlerImplementation::
        Iterators<DoFHandlerType, level_dof_access>::cell_iterator(
          &this->get_triangulation(), this->level(), this->index(), &this->get_dof_handler());
    }
...
inline DoFAccessor<0, DoFHandlerType<1, spacedim>, level_dof_access>::DoFAccessor()
{
  Assert(false, ExcInvalidObject());
}
...
inline DoFAccessor<0, DoFHandlerType<1, spacedim>, level_dof_access>::DoFAccessor(
  ...
  dof_handler(nullptr)
{
  Assert(false, ExcMessage("This constructor can not be called for face iterators in 1d."));
}
...
template <template <int, int> class DoFHandlerType, int spacedim, bool level_dof_access>
inline void DoFAccessor<0, DoFHandlerType<1, spacedim>, level_dof_access>::set_dof_handler(
...
template <template <int, int> class DoFHandlerType, int spacedim, bool level_dof_access>
inline void
DoFAccessor<0, DoFHandlerType<1, spacedim>, level_dof_access>::get_mg_dof_indices(
  const int,
  std::vector<types::global_dof_index> &dof_indices,
  const unsigned int                    fe_index) const
{
  ...
  (void)fe_index;
  Assert(this->dof_handler != nullptr, ExcInvalidObject());
  Assert(dof_indices.size() == this->dof_handler->get_fe(fe_index).dofs_per_vertex,
         ExcVectorDoesNotMatch());
...
template <template <int, int> class DoFHandlerType, int spacedim, bool level_dof_access>
inline unsigned int
DoFAccessor<0, DoFHandlerType<1, spacedim>, level_dof_access>::n_active_fe_indices() const
{
  Assert(false, ExcNotImplemented());
...
template <template <int, int> class DoFHandlerType, int spacedim, bool level_dof_access>
inline unsigned int
DoFAccessor<0, DoFHandlerType<1, spacedim>, level_dof_access>::nth_active_fe_index(
...
template <template <int, int> class DoFHandlerType, int spacedim, bool level_dof_access>
inline bool
DoFAccessor<0, DoFHandlerType<1, spacedim>, level_dof_access>::fe_index_is_active(
  const unsigned int /*fe_index*/) const
{
  Assert(false, ExcNotImplemented());
  return false;
...
template <template <int, int> class DoFHandlerType, int spacedim, bool level_dof_access>
inline TriaIterator<DoFAccessor<0, DoFHandlerType<1, spacedim>, level_dof_access>>
  ...
  namespace DoFCellAccessorImplementation
  {
    ...
    struct Implementation
    {
      ...
      update_cell_dof_indices_cache(
        const DoFCellAccessor<DoFHandler<1, spacedim>, level_dof_access> &accessor)
      {
        ...
        // this cell
        Assert(
          accessor.present_index * dofs_per_cell + dofs_per_cell <=
            accessor.dof_handler->levels[accessor.present_level]->cell_dof_indices_cache.size(),
          ExcInternalError());

        std::vector<types::global_dof_index>::iterator next =
          (accessor.dof_handler->levels[accessor.present_level]->cell_dof_indices_cache.begin() +
      ...
      static void
      update_cell_dof_indices_cache(
        const DoFCellAccessor<DoFHandler<2, spacedim>, level_dof_access> &accessor)
      {
        // check as in documentation that
        // cell is either active, or dofs
        // are only in vertices. otherwise
      ...
      static void
      update_cell_dof_indices_cache(
        const DoFCellAccessor<DoFHandler<3, spacedim>, level_dof_access> &accessor)
      {
        // check as in documentation that
        // cell is either active, or dofs
        // are only in vertices. otherwise
        ...
        for (unsigned int line = 0; line < 12; ++line)
          for (unsigned int d = 0; d < dofs_per_line; ++d)
            *next++ = accessor.line(line)->dof_index(
              accessor.dof_handler->get_fe().adjust_line_dof_index_for_line_orientation(
                d, accessor.line_orientation(line)));
        // now copy dof numbers from the face. for
        // faces with the wrong orientation, we
        // have already made sure that we're ok by
        ...
        for (unsigned int quad = 0; quad < 6; ++quad)
          for (unsigned int d = 0; d < dofs_per_quad; ++d)
            *next++ = accessor.quad(quad)->dof_index(
              accessor.dof_handler->get_fe().adjust_quad_dof_index_for_face_orientation(
                d,
                accessor.face_orientation(quad),
                accessor.face_flip(quad),
                accessor.face_rotation(quad)));
      ...
      static void
      update_cell_dof_indices_cache(
        const DoFCellAccessor<dealii::hp::DoFHandler<dim, spacedim>, level_dof_access> &accessor)
      {
        ...
        Assert(static_cast<unsigned int>(accessor.present_index) <
                 accessor.dof_handler->levels[accessor.present_level]->cell_cache_offsets.size(),
               ExcInternalError());
        Assert(
        ...
        static_cast<
          const dealii::DoFAccessor<dim, dealii::hp::DoFHandler<dim, spacedim>, level_dof_access>
            &>(accessor)
                      ...
                      const std::vector<types::global_dof_index> &             local_dof_indices)
      {
        ...
        Assert(local_dof_indices.size() == accessor.get_fe().dofs_per_cell, ExcInternalError());
        ...
        for (unsigned int d = 0; d < dofs_per_hex; ++d, ++index)
          accessor.set_dof_index(d, local_dof_indices[index], accessor.active_fe_index());
      ...
      static void
      set_active_fe_index(
        const DoFCellAccessor<DoFHandler<dim, spacedim>, level_dof_access> &accessor,
        const unsigned int                                                  i)
      {
        (void)accessor;
        (void)i;
        // ::DoFHandler only supports a single active fe with index
        // zero
        Assert(i == 0, (typename std::decay<decltype(accessor)>::type::ExcInvalidObject()));
      }
        ...
        const unsigned int                                                              i)
      {
        ...
        accessor.dof_handler->levels[accessor.level()]->set_active_fe_index(accessor.present_index,
                                                                            i);
      }
      ...
      distribute_local_to_global(
        const DoFCellAccessor<dealii::DoFHandler<dim, spacedim>, level_dof_access> &accessor,
        ...
        OutputVector &  global_destination)
      {
        ...
        // distribute cell vector
        constraints.distribute_local_to_global(
          local_source_begin, local_source_end, dofs.begin(), global_destination);
      }
...
inline DoFCellAccessor<DoFHandlerType, level_dof_access>::DoFCellAccessor(
  ...
  DoFAccessor<DoFHandlerType::dimension, DoFHandlerType, level_dof_access>(tria,
                                                                           level,
                                                                           index,
                                                                           local_data)
{}
...
DoFCellAccessor<DoFHandlerType, level_dof_access>::neighbor(const unsigned int i) const
{
  TriaIterator<DoFCellAccessor<DoFHandlerType, level_dof_access>> q(
    this->tria, this->neighbor_level(i), this->neighbor_index(i), this->dof_handler);
...
namespace internal
{
  namespace DoFCellAccessorImplementation
  {
    template <typename DoFHandlerType, bool level_dof_access>
    inline TriaIterator<
      dealii::DoFAccessor<DoFHandlerType::dimension - 1, DoFHandlerType, level_dof_access>>
  ...
  std::vector<types::global_dof_index> &dof_indices) const
{
  ...
  if (dofs_per_cell > 0)
    {
      const types::global_dof_index *cache =
        this->dof_handler->levels[this->present_level]->get_cell_cache_start(this->present_index,
                                                                             dofs_per_cell);
...
DoFCellAccessor<DoFHandlerType, level_dof_access>::get_mg_dof_indices(
  std::vector<types::global_dof_index> &dof_indices) const
{
  DoFAccessor<dim, DoFHandlerType, level_dof_access>::get_mg_dof_indices(this->level(),
                                                                         dof_indices);
}
...
DoFCellAccessor<DoFHandlerType, level_dof_access>::set_mg_dof_indices(
  const std::vector<types::global_dof_index> &dof_indices)
{
  DoFAccessor<dim, DoFHandlerType, level_dof_access>::set_mg_dof_indices(this->level(),
                                                                         dof_indices);
}
  ...
  ForwardIterator         local_values_end) const
{
  ...
  constraints.get_dof_values(values, *cache, local_values_begin, local_values_end);
}
  ...
  OutputVector &        values) const
{
  ...
  Assert(static_cast<unsigned int>(local_values.size()) == this->get_fe().dofs_per_cell,
         typename DoFCellAccessor::ExcVectorDoesNotMatch());
  Assert(values.size() == this->get_dof_handler().n_dofs(),
         typename DoFCellAccessor::ExcVectorDoesNotMatch());
...
{
  Assert((dynamic_cast<
            const dealii::DoFHandler<DoFHandlerType::dimension, DoFHandlerType::space_dimension> *>(
...
{
  dealii::internal::DoFCellAccessorImplementation::Implementation::distribute_local_to_global(
...
{
  dealii::internal::DoFCellAccessorImplementation::Implementation::distribute_local_to_global(
    *this, constraints, local_source_begin, local_source_end, global_destination);
}
