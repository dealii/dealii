...
namespace GridTools
{
  ...
  /**
   * Project a point to Triangulation Iterator object.
   *
   * Returns the closest point to @p trial_point that lies on the given iterator object.
   *
...
namespace GridTools
{
                    ...
                    const Point<Iterator::AccessorType::space_dimension> &trial_point)
  {
    ...
    if (structdim == 1 && spacedim <= 1)
      return trial_point;
    else if (structdim == 2 && spacedim <= 2)
      return trial_point;
    else if (structdim == 3 && spacedim <= 3)
      return trial_point;
    else if (structdim == 1)
      {
        ...
        // line is linear
        const Point<spacedim> p1 = object->vertex(0),
                              p2 = object->vertex(1);
    ...
    else if (structdim == 2)
      {
        ...
        // is structdim-linear in \xi, so J(\xi) is
        // a polynomial of degree 2*structdim that
        // we'd like to minimize. unless structdim==1,
