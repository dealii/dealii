...
namespace LocalIntegrators
{
  ...
  namespace Divergence
  {
                ...
                double                   factor = 1.)
    {
      ...
      DEAL_II_AssertDimension(fetest.get_fe().n_components(), 1);
      ...
      const double factor = 1.)
    {
      ...
      const unsigned int t_dofs = fetest.dofs_per_cell;
      DEAL_II_Assert(result.size() == t_dofs,
                    ...
                    double                   factor = 1.)
    {
      ...
      DEAL_II_AssertDimension(fetest.get_fe().n_components(), dim);
    ...
    {
      DEAL_II_AssertDimension(fetest.get_fe().n_components(), dim);
      DEAL_II_AssertDimension(input.size(), fetest.n_quadrature_points);
      const unsigned int t_dofs = fetest.dofs_per_cell;
      DEAL_II_Assert(result.size() == t_dofs,
                     ExcDimensionMismatch(result.size(), t_dofs));
      ...
      double                                                     factor = 1.)
    {
      ...
      DEAL_II_AssertDimension(fe.get_fe().n_components(), dim);
      DEAL_II_AssertDimension(fetest.get_fe().n_components(), 1);
      DEAL_II_AssertDimension(result.size(), t_dofs);
                       ...
                       double                     factor = 1.)
    {
      ...
      DEAL_II_AssertDimension(fetest.get_fe().n_components(), dim);
      DEAL_II_AssertDimension(result.size(), t_dofs);
      DEAL_II_AssertDimension(data.size(), fetest.n_quadrature_points);
                   ...
                   double                   factor = 1.)
    {
      ...
      DEAL_II_AssertDimension(fetest1.get_fe().n_components(), 1);
      DEAL_II_AssertDimension(fetest2.get_fe().n_components(), 1);
      DEAL_II_AssertDimension(M11.m(), t_dofs);
      DEAL_II_AssertDimension(M11.n(), n_dofs);
      DEAL_II_AssertDimension(M12.m(), t_dofs);
      DEAL_II_AssertDimension(M12.n(), n_dofs);
      DEAL_II_AssertDimension(M21.m(), t_dofs);
      DEAL_II_AssertDimension(M21.n(), n_dofs);
      DEAL_II_AssertDimension(M22.m(), t_dofs);
    ...
    {
      DEAL_II_AssertDimension(fe.get_fe().n_components(), dim);
      DEAL_II_AssertVectorVectorDimension(Du, dim, fe.n_quadrature_points);
