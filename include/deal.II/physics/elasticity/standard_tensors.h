...
namespace Physics
{
  namespace Elasticity
  {
    ...
    public:
       ...
       *   $z$-direction, with the assumption that the $z$-displacements are zero
       *   and that the $x$- and $y$-displacements do not vary in $z$-direction.
       *   Such models are often described as
       *   "[plane strain](https://en.wikipedia.org/wiki/Infinitesimal_strain_theory#Plane_strain)",
       *   indicating that nonzero strain components are all in the
