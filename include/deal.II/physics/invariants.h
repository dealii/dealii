...
namespace Physics
{
  namespace Invariants
  {
    namespace internal
    {
       ...
       * @return The tensor $\mathbf{S} \cdot \mathbf{T}$
       */
                                   ...
                                   const SymmetricTensor<2, dim, ScalarType> &C)
    {
      ...
      AssertThrow(false, ExcMessage("This (pseudo-)invariant is not defined."));
      return ScalarType();
    }
      ...
      switch (i)
        {
          case I1:
            {
              return Isotropic<dim, ScalarType>::Ii(i, C);
            }
            break;
          case I2:
            {
          ...
          case pI5:
            {
              // pI5 = I3 C^{-1} : G
              const ScalarType I3 =
                Isotropic<dim, ScalarType>::Ii(Invariants::I3, C);
              return I3 * (C_inv * G);
            }
            break;
          default:
      ...
      switch (i)
        {
          case I1:
            {
              return Isotropic<dim, ScalarType>::dIi_dC(i, C, C_inv);
            }
            break;
          case I2:
            {
      ...
      switch (i)
        {
          case I1:
            {
              return Isotropic<dim, ScalarType>::d2Ii_dC_dC(i, C, C_inv);
            }
            break;
          case I2:
            {
                  ...
                  for (unsigned int A = 0; A < dim; ++A)
                    for (unsigned int B = 0; B < dim; ++B)
                      d_C_inv_ddot_G_dC[C][D] -=
                        (0.5 * G[A][B]) *
                        (C_inv[A][C] * C_inv[B][D] + C_inv[A][D] * C_inv[B][C]);
      ...
      switch (i)
        {
          ...
          case I4:
            {
              return TransverseIsotropic<dim, ScalarType>::Ii(i, C, C_inv, G1);
            }
            break;
          case I5:
            {
          ...
          case I6:
            {
              // I6 = C : G2 == I4(G2)
              return TransverseIsotropic<dim, ScalarType>::Ii(I4, C, C_inv, G2);
            }
            break;
          case I7:
            {
              // I7 = C^{2} : G2 == I5(G2)
              return TransverseIsotropic<dim, ScalarType>::Ii(I5, C, C_inv, G2);
            }
            break;
          case pI7:
            {
              // pI7 = I3 C^{-1} : G2 == pI5(G2)
              return TransverseIsotropic<dim, ScalarType>::Ii(pI5,
                                                              C,
                                                              C_inv,
                                                              G2);
            }
      ...
      switch (i)
        {
          ...
          case I4:
            {
              return TransverseIsotropic<dim, ScalarType>::dIi_dC(i,
                                                                  C,
                                                                  C_inv,
                                                                  G1);
            }
          ...
          case I6:
            {
              // I6 = C : G2 == I4(G2)
              return TransverseIsotropic<dim, ScalarType>::dIi_dC(I4,
                                                                  C,
                                                                  C_inv,
                                                                  G2);
            }
          ...
          case I7:
            {
              // I7 = C^{2} : G2 == I5(G2)
              return TransverseIsotropic<dim, ScalarType>::dIi_dC(I5,
                                                                  C,
                                                                  C_inv,
                                                                  G2);
            }
          ...
          case pI7:
            {
              // pI7 = I3 C^{-1} : G2 == pI5(G2)
              return TransverseIsotropic<dim, ScalarType>::dIi_dC(pI5,
                                                                  C,
                                                                  C_inv,
                                                                  G2);
            }
      ...
      switch (i)
        {
          ...
          case I4:
            {
              return TransverseIsotropic<dim, ScalarType>::d2Ii_dC_dC(i,
                                                                      C,
                                                                      C_inv,
                                                                      G1);
            }
          ...
          case I6:
            {
              // I6 = C : G2 == I4(G2)
              return TransverseIsotropic<dim, ScalarType>::d2Ii_dC_dC(I4,
                                                                      C,
                                                                      C_inv,
                                                                      G2);
            }
          ...
          case I7:
            {
              // I7 = C^{2} : G2 == I5(G2)
              return TransverseIsotropic<dim, ScalarType>::d2Ii_dC_dC(I5,
                                                                      C,
                                                                      C_inv,
                                                                      G2);
            }
          ...
          case pI7:
            {
              // pI7 = I3 C^{-1} : G2 == pI5(G2)
              return TransverseIsotropic<dim, ScalarType>::d2Ii_dC_dC(pI5,
                                                                      C,
                                                                      C_inv,
                                                                      G2);
            }
          ...
          case pI11b:
            {
              ...
              const ScalarType pI3 =
                Isotropic<dim, ScalarType>::Ii(Invariants::pI3, C);
                    ...
                    for (unsigned int D = C; D < dim; ++D)
                      {
                        ...
                        d2I11_dC_dC[A][B][C][D] =
                          0.5 * (H[A] * H[D] * I[B][C] + H[A] * H[C] * I[B][D] +
          ...
          case pI11b:
            {
              ...
              const SymmetricTensor<4, dim, ScalarType> d2I11a_dC_dC =
                CoupledIsotropic<dim, ScalarType>::d2Ii_dC_dC(pI11a,
                                                              C,
                                                              C_inv,
                                                              H);
          ...
          case pI11b:
            {
              ...
              const Tensor<3, dim, ScalarType> d2pI11a_dC_dH =
                CoupledIsotropic<dim, ScalarType>::d2Ii_dC_dH(pI11a,
                                                              C,
                                                              C_inv,
                                                              H);
      ...
      const Tensor<1, dim, ScalarType> &         H)
    {
      ...
      const Tensor<3, dim, ScalarType> d2Ii_dC_dH =
        CoupledIsotropic<dim, ScalarType>::d2Ii_dC_dH(i, C, C_inv, H);
      ...
      switch (i)
        {
          ...
          case I4:
            {
              return TransverseIsotropic<dim, ScalarType>::Ii(i, C, C_inv, G);
            }
            break;
          case I5:
            {
          ...
          case I9:
            {
              return CoupledIsotropic<dim, ScalarType>::Ii(i, C, C_inv, H);
            }
            break;
          case I10:
            {
      ...
      switch (i)
        {
          ...
          case I9:
            {
              return CoupledIsotropic<dim, ScalarType>::dIi_dC(i, C, C_inv, H);
            }
            break;
          case I10:
            {
      ...
      switch (i)
        {
          ...
          case I9:
            {
              return CoupledIsotropic<dim, ScalarType>::dIi_dH(i, C, C_inv, H);
            }
            break;
          case I10:
            {
      ...
      switch (i)
        {
          ...
          case I9:
            {
              return CoupledIsotropic<dim, ScalarType>::d2Ii_dC_dC(i,
                                                                   C,
                                                                   C_inv,
                                                                   H);
            }
                ...
                for (unsigned int B = A; B < dim; ++B)
                  for (unsigned int C = 0; C < dim; ++C)
                    for (unsigned int D = C; D < dim; ++D)
                      {
                        d2I13_dC_dC[A][B][C][D] =
                          0.5 * (H[A] * G[B][C] * H[D] + H[A] * G[B][D] * H[C]);
      ...
      switch (i)
        {
          ...
          case I9:
            {
              return CoupledIsotropic<dim, ScalarType>::d2Ii_dH_dH(i,
                                                                   C,
                                                                   C_inv,
                                                                   H);
            }
      ...
      switch (i)
        {
          ...
          case I9:
            {
              return CoupledIsotropic<dim, ScalarType>::d2Ii_dC_dH(i,
                                                                   C,
                                                                   C_inv,
                                                                   H);
            }
