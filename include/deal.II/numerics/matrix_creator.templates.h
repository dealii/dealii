...
namespace MatrixCreator
{
  ...
  namespace internal
  {
    ...
    template <int dim, int spacedim, typename number>
    void
    copy_boundary_mass_matrix_1(MatrixCreator::internal::AssemblerBoundary::CopyData<DoFHandler<dim,
    ...
    void
    inline
    create_boundary_mass_matrix_1<1,3,float>
    ...
    void
    inline
    create_boundary_mass_matrix_1<1,3,double>
    (DoFHandler<1,3>::active_cell_iterator const &/*cell*/,
     MatrixCreator::internal::AssemblerBoundary::Scratch const &,
     MatrixCreator::internal::AssemblerBoundary::CopyData<DoFHandler<1,
     3>,double > &/*copy_data*/,
  ...
  namespace
  {
    ...
    template <int dim, int spacedim, typename number>
    void
    copy_hp_boundary_mass_matrix_1(MatrixCreator::internal::AssemblerBoundary
  ...
  template <int dim, int spacedim, typename number>
  void
  create_boundary_mass_matrix (const DoFHandler<dim,spacedim>     &dof,
                               const Quadrature<dim-1>   &q,
                               SparseMatrix<typename numbers::NumberTraits<number>::real_type>      &matrix,
  ...
  template <int dim, int spacedim, typename number>
  void
  create_boundary_mass_matrix (const hp::DoFHandler<dim,spacedim>     &dof,
                               const hp::QCollection<dim-1>   &q,
                               SparseMatrix<typename numbers::NumberTraits<number>::real_type>      &matrix,
                               const std::map<types::boundary_id, const Function<spacedim,number>*> &rhs,
                               Vector<number>            &rhs_vector,
