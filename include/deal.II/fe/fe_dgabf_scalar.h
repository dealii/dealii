...
#ifndef __deal2__fe_dgabf_scalar_h
#define __deal2__fe_dgabf_scalar_h
...
class FE_DGABF_Scalar : public FE_Poly<ABFScalarPolynomials<dim>, dim, spacedim>
{
public:
  /**
   ...
   */
  FE_DGABF_Scalar (const unsigned int p);
...
private:
   ...
   */
  template <int dim1, int spacedim1> friend class FE_DGABF_Scalar;
