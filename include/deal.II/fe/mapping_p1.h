 ...
 * independent of $(\hat{x}, \hat{y})$: i.e., it is affine, not bilinear or
 * trilinear. An important property of this mapping is that all the
 * transformation matrices (i.e., the covariant and contravariant
 * transformations) are constant on each element - utilizing this property makes
 * this mapping significantly more efficient than an equivalent MappingFE class
 * set up with a linear FE_SimplexP.
 */
...
public:
  ...
  /**
   * @copydoc Mapping::transform_points_real_to_unit_cell()
   */
  virtual void
  ...
  public:
    ...
    /**
     * @copydoc Mapping::InternalDataBase
     */
    virtual void
...
private:
  /**
   * @copydoc Mapping::requires_update_flags()
   */
  virtual UpdateFlags
  requires_update_flags(const UpdateFlags update_flags) const override;

  /**
   * @copydoc Mapping::get_data()
   */
  ...
  /**
   * @copydoc Mapping::fill_fe_face_values()
   */
  virtual void
  fill_fe_face_values(
    const typename Triangulation<dim, spacedim>::cell_iterator &cell,
  ...
  /**
   * @copydoc Mapping::fill_fe_subface_values()
   */
  virtual void
