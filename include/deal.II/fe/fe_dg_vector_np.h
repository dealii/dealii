...
#ifndef __deal2__fe_dg_vector_np_h
#define __deal2__fe_dg_vector_np_h
...
class FE_DGVector_NP
  :
  public FE_PolyTensor_NP<POLY, dim, spacedim>
{
public:
  /**
   * Constructor for the vector element of degree @p p.
   */
  FE_DGVector_NP (const unsigned int p, MappingType m);
public:
