...
namespace MeshWorker
{
   ...
   * @ingroup MeshWorker
   */
  class DEAL_II_DEPRECATED VectorSelector : public EnableObserverPointer
  {
  public:
    /**
  ...
  class DEAL_II_DEPRECATED VectorDataBase : public VectorSelector
  {
  public:
    /**
     * Constructor
  ...
  class DEAL_II_DEPRECATED VectorData
   ...
   */
  template <typename VectorType, int dim, int spacedim = dim>
  class DEAL_II_DEPRECATED MGVectorData
