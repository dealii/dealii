...
namespace
{
      ...
      if (runtime_n_q_points_1d == n_q_points_1d)
        {
          if (n_q_points_1d == degree + 1 &&
            ...
            internal::FEEvaluationImplCollocation<dim, degree, n_components, Number>::evaluate(
              shape_info,
              values_dofs_actual,
              values_quad,
              gradients_quad,
            ...
            internal::FEEvaluationImplTransformToCollocation<dim,
                                                             degree,
                                                             n_q_points_1d,
                                                             n_components,
                                                             Number>::evaluate(shape_info,
        ...
        Factory<dim, n_components, Number, 1, degree, n_q_points_1d + 1>::evaluate(
          shape_info,
          values_dofs_actual,
          values_quad,
          gradients_quad,
      ...
      if (runtime_n_q_points_1d == n_q_points_1d)
        {
          if (n_q_points_1d == degree + 1 &&
              shape_info.element_type ==
                internal::MatrixFreeFunctions::tensor_symmetric_collocation)
            internal::FEEvaluationImplCollocation<dim, degree, n_components, Number>::integrate(
              shape_info,
              values_dofs_actual,
              values_quad,
              gradients_quad,
        ...
        Factory<dim, n_components, Number, 1, degree, n_q_points_1d + 1>::integrate(
          shape_info,
          values_dofs_actual,
          values_quad,
          gradients_quad,
  ...
  template <int dim, int n_components, typename Number>
  void
  symmetric_selector_evaluate(const internal::MatrixFreeFunctions::ShapeInfo<Number> &shape_info,
                              Number *   values_dofs_actual,
                              Number *   values_quad,
                              Number *   gradients_quad,
                              Number *   hessians_quad,
  ...
  template <int dim, int n_components, typename Number>
  void
  symmetric_selector_integrate(const internal::MatrixFreeFunctions::ShapeInfo<Number> &shape_info,
                               Number *   values_dofs_actual,
                               Number *   values_quad,
                               Number *   gradients_quad,
                               Number *   scratch_data,
  ...
  const bool                                              evaluate_hessians)
{
  ...
  if (fe_degree + 1 == n_q_points_1d &&
    ...
    {
      internal::FEEvaluationImplCollocation<dim, fe_degree, n_components, Number>::evaluate(
        shape_info,
        values_dofs_actual,
        values_quad,
        gradients_quad,
  ...
  const bool                                              integrate_gradients)
{
  ...
  if (fe_degree + 1 == n_q_points_1d &&
      shape_info.element_type == internal::MatrixFreeFunctions::tensor_symmetric_collocation)
    {
      internal::FEEvaluationImplCollocation<dim, fe_degree, n_components, Number>::integrate(
        shape_info,
        values_dofs_actual,
        values_quad,
        gradients_quad,
  ...
  const bool                                              integrate_gradients)
{
  if (shape_info.element_type == internal::MatrixFreeFunctions::tensor_symmetric_plus_dg0)
    ...
    symmetric_selector_integrate<dim, n_components, Number>(shape_info,
                                                            values_dofs_actual,
                                                            values_quad,
                                                            gradients_quad,
                                                            scratch_data,
