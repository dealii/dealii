...
namespace dealii::MatrixFreeUtils
{
   ...
   * The type <tt>DomainVector</tt> needs to provide reinit(const DomainVector&,
   bool=false) to create a zero vector.
  ...
  /**
   * Variant of assemble_operator using dealii::Vector as domain and range
   * vectors.
   */
