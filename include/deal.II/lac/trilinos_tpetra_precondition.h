...
#  ifdef DEAL_II_TRILINOS_WITH_SHYLU_DDFROSCH
    /**
     * @brief The class for the FROSch preconditioner
     *
    ...
    public:
      ...
      struct AdditionalData
      {
        ...
        int dimension;
        /**
         * @brief The combine method in the overlap.
         *
        ...
        /**
         * @brief Specify the direct solver for the subdomains.
         *
        ...
        /**
         * @brief Specify the coarse space operator. Only used by two-level methods.
         *
         * Available options:
         * <ul>
        ...
        /**
         * @brief The solver used for the extension space problem.
        ...
        /**
         * @brief The solver used for the coarse space problem.
         * For the available options, see the description of the
         * subdomain_solver.
         */
      ...
      /**
       * @brief Construct a FROSch preconditioner.
       *
       *  Available options:
       *  <ul>
       *  <li> "One Level" </li>
      ...
      /**
       * @brief Compute the preconditioner based on the given matrix, the dof_handler and parameters.
       *
