...
#    ifdef DEAL_II_TRILINOS_WITH_TPETRA_MUELU
    ...
    public:
      ...
      struct AdditionalData
      {
         ...
         * @param constant_modes Specify constant modes (near null space) of the matrix.
         ...
         * @param relaxation_type Determine the specific smoother for type RELAXATION.
         */
         ...
         * Otherwise it determines how ofter the matrix-vector product of the
         * smoother is applied.
         */
        int smoother_sweeps;
        /**
       ...
       * you should use the other intialize function.
       */
      void
      initialize(SparseMatrix<Number, MemorySpace> &A,
                 const AdditionalData &additional_data = AdditionalData());
