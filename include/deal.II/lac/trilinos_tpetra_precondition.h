...
#  ifdef DEAL_II_TRILINOS_WITH_SHYLU_DDFROSCH
    ...
    public:
       ...
       * direct solver to use for the local problem on each subdomain.
       */
      enum SolverName
      {
        /**
         * Default solver, which is used to solve the local problems on the
         * subdomains.
         */
        KLU,
        /**
         * Use UMFPACK as direct solver for the local problems.
         * Requires Trilinos Amesos2 to be configured to use UMFPACK.
         */
        UMFPACK,
        /**
         * Use MUMPS as direct solver for the local problems.
         * Requires Trilinos Amesos2 to be configured to use MUMPS.
         */
        MUMPS,
        /**
         * Use as SuperLU_dist solver for the local problems.
         * Requires Trilinos Amesos2 to be configured to use SuperLU_dist.
         */
        SuperLU_dist
      };
       ...
       * and parameters.
       *
       * With the additional geometric information from the triangulation and
    ...
    private:
      /**
       * An enum that stores whether FROSch uses a one- or two-level method.
      ...
      /**
       * A boolean indicating whether a ParameterList was provided by the user.
       * If no ParameterList was provided by the user, this class uses
